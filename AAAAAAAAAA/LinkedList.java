...
public class LinkedList {
    public static Node create(Node start) {
        ...
        while (true) {
            ...
            System.out.print("Do you want to add more to it (y/n) : ");
    ...
    public static Node InsEnd(Node start) {
        ...
        Node newNode = new Node(regd_no, mark);
        if (start == null) {
           System.out.println("List is empty,Enter the element at the beginningg");
           create(start);
        }
        Node current = start;
        while (current.next != null) {
    ...
    public static Node DelAny(Node start, int pos) {
        ...
        current.next=null;//Due to garbage store's
        return start;
    }
